...
private:
    ...
    // notes: this is mapping an entity to its component's index in the components vector 
	bool registered = false;
public:
	// Container of all components of type 'Component'
	std::vector<Component> components;
    // notes: storing components in a vector allows fast iteration because they are stored contiguously in memory. 
	...
	inline Component& insert(Entity e, Component c, bool check_for_duplicates = true)
	{
        ...
        // notes: `move` transfers ownership of object, avoids memory allocation and data duplication. 
